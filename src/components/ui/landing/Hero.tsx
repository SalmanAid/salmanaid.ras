        ...
        <div className="relative z-10 max-w-7xl mx-auto h-full px-6 md:px-8 flex items-center">
          <div className="max-w-2xl text-white">
            <h1 className="text-[2.35rem] md:text-[3.45rem] leading-[1.05] font-extrabold tracking-tight">
              Memberdayakan Mahasiswa dengan Pinjaman Tanpa Bunga
            </h1>
            <p className="mt-5 text-[13.5px] md:text-[16px] text-white/85 leading-relaxed max-w-[52ch]">
              Bekerja sama dengan Rumah Amal Salman, RAS menyediakan bantuan keuangan yang beretika dan sesuai syariah kepada siswa yang membutuhkan tanpa bunga sama sekali.
            </p>
          </div>
        </div>
      </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="mt-4 text-[13.5px] text-gray-600 leading-relaxed max-w-[48ch]">
                  Bantu danai pinjaman tanpa bunga dan dukung siswa dalam mewujudkan impian pendidikan mereka.
                </p>
                <Link
          ...
          <div className="p-6 md:p-7">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="mt-4 text-[13.5px] text-gray-600 leading-relaxed max-w-[48ch]">
                  Mahasiswa dapat mengajukan pinjaman tanpa bunga untuk menutupi biaya kuliah, buku, dan biaya hidup.
                </p>
                <Link
